	...
	<div class="row" >
						...
						STUDENT NAME
								<div class="form-group" >
								  ...
								  <div class="form-group" >
									...
									<div class="col-md-9">
									  <input type="text" class="form-control" name="proctorid" placeholder="Enter Proctor's ID">
									</div>
								  </div>
			...
			<option value="8D">8D</option>
								 ...
								 <div class="form-group" >
									...
									<div class="col-md-9">
									  <input type="radio" value="Yes" name="shift" />Yes <input type="radio" value="No" name="shift" selected="selected"/>No
									</div>
								  </div>
					  ...
					  <tr>
						...
						<option value="Scheduled Tribe(ST)">Scheduled Tribe(ST)</option>
								  ...
								  <div class="form-group" >
									...
									<div class="col-md-9">
									  <input type="text" class="form-control"  name="ecobg" placeholder="Enter your Economic Background" style="width:60%;"/>
									</div>
								  </div>
			...
			<tr>
						...
						PARENTS DETAILS
								<div class="form-group" >
								  ...
								  <div class="form-group" >
									...
									<div class="col-md-9">
									  <input type="text" class="form-control" name="motherphone" placeholder="Enter Mother's Phone No." />
									</div>
								  </div>
								  ...
								  <div class="form-group" >
									...
									<div class="col-md-9">
									  <input type="text" class="form-control" name="fatherphone" placeholder="Enter father's Phone No." />
									</div>
								  </div>
					  ...
					  <tr>
                        ...
                        <td>
								...
								<tr>
									<th>GRADE POINT</th>
									<td><input type="text" class="form-control" name="sem1" placeholder="1st Sem" style="width:100%;"/></td>
									<td><input type="text" class="form-control" name="sem2" placeholder="2nd Sem" style="width:100%;"/></td>
									<td><input type="text" class="form-control" name="sem3" placeholder="3rd Sem" style="width:100%;"/></td>
									<td><input type="text" class="form-control"  name="sem4" placeholder="4th Sem" style="width:100%;"/></td>
									<td><input type="text" class="form-control"  name="sem5" placeholder="5th Sem" style="width:100%;"/></td>
									<td><input type="text" class="form-control"  name="sem6" placeholder="6th Sem" style="width:100%;"/></td>
									<td><input type="text" class="form-control"  name="sem7" placeholder="7th Sem" style="width:100%;"/></td>
									<td><input type="text" class="form-control"  name="sem8" placeholder="8th Sem" style="width:100%;"/></td>
									<td><input type="text" class="form-control"  name="cgpa" placeholder="8th Sem" style="width:100%;"/></td>
				...
				<tr>
						...
						<b>Permanent Address:</b>
								<div class="form-group" >
									...
									<div class="col-md-9">
									  <input type="text" class="form-control"  name="resadd" placeholder="Enter Permanent Address" />
									</div>
								  </div>
								  ...
								  <div class="form-group" >
									...
									<div class="col-md-9">
									  <input type="text" class="form-control"  name="resdist" placeholder="Enter District" />
									</div>
								  </div>
								  ...
								  <div class="form-group" >
									...
									<div class="col-md-9">
									  <input type="text" class="form-control" name="resstate" placeholder="Enter State" />
									</div>
								  </div>
								  ...
								  <div class="form-group" >
									...
									<div class="col-md-9">
									  <input type="text" class="form-control" name="respin" placeholder="Enter Pin Code" />
									</div>
								  </div>
						...
						<b>Local Address:</b>
								<div class="form-group" >
									<label class="control-label col-md-3" >Address Line:</label>
									<div class="col-md-9">
									  <input type="text" class="form-control"  name="localadd" placeholder="Enter Local Address" />
									</div>
								  </div>
								  ...
								  <div class="form-group" >
									<label class="control-label col-md-3" >District:</label>
									<div class="col-md-9">
									  <input type="text" class="form-control" name="localdist" placeholder="Enter District" />
									</div>
								  </div>
								  ...
								  <div class="form-group" >
									<label class="control-label col-md-3" >State:</label>
									<div class="col-md-9">
									  <input type="text" class="form-control" name="localstate" placeholder="Enter State" />
									</div>
								  </div>
								  ...
								  <div class="form-group" >
									<label class="control-label col-md-3" >Pin Code:</label>
									<div class="col-md-9">
									  <input type="text" class="form-control"  name="localpin" placeholder="Enter Pin Code" />
									</div>
								  </div>
			...
			<tr>
						...
						FEES DETAILS
								<div class="form-group" >
								  ...
								  <div class="form-group" >
									...
									<div class="col-md-9">
									  <input type="text" class="form-control" name="fees" placeholder="Enter fees amount paid" style="width:60%;"/>
									</div>
								  </div>
					 ...
					 <tr>
                        ...
                        <td>
								...
								<tr>
									<th>1</th>
									<td><input type="text" class="form-control" name="extracurr1" placeholder="1st Activity" style="width:100%;"/></td>
								</tr>
								<tr>
									<th>2</th>
									<td><input type="text" class="form-control"  name="extracurr2" placeholder="2nd Activity" style="width:100%;"/></td>
								</tr>
								<tr>
									<th>3</th>
									<td><input type="text" class="form-control" name="extracurr3" placeholder="3rd Activity" style="width:100%;"/></td>
								</tr>
								<tr>
									<th>4</th>
									<td><input type="text" class="form-control" name="extracurr4" placeholder="4th Activity" style="width:100%;"/></td>
								</tr>
								<tr>
									<th>5</th>
									<td><input type="text" class="form-control" name="extracurr5" placeholder="5th Activity" style="width:100%;"/></td>
								</tr>
					 ...
					 <tr>
                        ...
                        <td>
								...
								<tr>
									<th>PG/CET</th>
									<td><input type="text" class="form-control" name="pgcet" placeholder="PG/CET Marks" style="width:100%;"/></td>
								</tr>
								<tr>
									<th>GATE</th>
									<td><input type="text" class="form-control" name="gate" placeholder="GATE Marks" style="width:100%;"/></td>
								</tr>
								<tr>
									<th>GMAT</th>
									<td><input type="text" class="form-control" name="gmat" placeholder="GMAT Marks" style="width:100%;"/></td>
								</tr>
								<tr>
									<th>GRE</th>
									<td><input type="text" class="form-control" name="gre" placeholder="GRE Marks" style="width:100%;"/></td>
								</tr>
								<tr>
									<th>TOEFL</th>
									<td><input type="text" class="form-control" name="toefl" placeholder="TOEFL" style="width:100%;"/></td>
								</tr>
					  ...
					  <tr>
                        ...
                        <td>
								...
								<tr>
									<th>1.</th>
									<td><input type="text" class="form-control" name="university1"  style="width:100%;"/></td>
									<td><input type="text" class="form-control" name="course1"  style="width:100%;"/></td>
								</tr>
								<tr>
									<th>2.</th>
									<td><input type="text" class="form-control" name="university2" style="width:100%;"/></td>
									<td><input type="text" class="form-control" name="course2" style="width:100%;"/></td>
								</tr>
								<tr>
									<th>3.</th>
									<td><input type="text" class="form-control" name="university3" style="width:100%;"/></td>
									<td><input type="text" class="form-control" name="course3" style="width:100%;"/></td>
								</tr>
					  ...
					  <tr>
                        ...
                        <td>
								...
								<tr>
									<th>1.</th>
									<td><input type="text" class="form-control" name="company1"  style="width:100%;"/></td>
									<td><input type="text" class="form-control" name="position1"  style="width:100%;"/></td>
								</tr>
								<tr>
									<th>2.</th>
									<td><input type="text" class="form-control" name="company2" style="width:100%;"/></td>
									<td><input type="text" class="form-control" name="position2" style="width:100%;"/></td>
								</tr>
								<tr>
									<th>3.</th>
									<td><input type="text" class="form-control" name="company3" style="width:100%;"/></td>
									<td><input type="text" class="form-control" name="position3" style="width:100%;"/></td>
								</tr>
