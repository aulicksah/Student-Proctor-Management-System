			...
			<center><h1 style="font-family: 'Aclonica';font-weight:26000; font-size:32px; color:#800000; padding-top:5px;">STUDENT DETAILS</h1></center>
				...
				<div class="panel panel-default" style=" ">
					<div class="panel-heading" style="background-color:#2d98da;"> 
						...
						<a href="admineditprofile.php?sid=<?php echo $rr['sid']; ?>"><button type="submit" class="btn btn-warning" style="float:right; font-size:24px; border:solid #FFFFFF;">Edit Profile</button></a><br/><br/><br/>
						</div>
					 	</div>
					</div>
...
<tr>
	...
	<td><?php echo $rr['cgpa']; ?></td>
				...
				<center><a href="admindeletestudent.php?sid=<?php echo $rr['sid']; ?>"><button type="submit" class="btn btn-danger" style=" font-size:24px; border:solid #FFFFFF;">Delete Profile</button></a></center>
				<?php } ?>
